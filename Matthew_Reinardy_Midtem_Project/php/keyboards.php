...
//Obtain the keyboards from the ProductInventory Class
$keyboards = $inventory->getProductsByCategory(4, 4);
?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <div class="product-list">
        <?php foreach ($keyboards as $product) { ?>
            <div class="product">
                <img src="<?= $product->getResizedImage(); ?>" alt="<?= $product->getName(); ?>">
                <h2><?= $product->getName(); ?></h2>
                <p><?= $product->getDescription(); ?></p>
                <p class="price"><?= '$' . $product->getPrice(); ?></p>
                <form method="POST" action="keyboards.php">
